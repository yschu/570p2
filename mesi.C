...
class mu_1_MessageType: public mu__byte
{
 public:
  ...
  mu_1_MessageType (char *name, int os): mu__byte(6, 18, 4, name, os) {};
  mu_1_MessageType (void): mu__byte(6, 18, 4) {};
  mu_1_MessageType (int val): mu__byte(6, 18, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1_MessageType::values[] = {"GetS","GetData","GetM","Inv","Inv_Ack","PutM","PutS","Put_Ack","Fwd_GetS","Fwd_GetM","Put_Ack_Back","PutE","ExData",NULL };
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (char *name, int os): mu__byte(19, 29, 4, name, os) {};
  mu_1__type_0 (void): mu__byte(19, 29, 4) {};
  mu_1__type_0 (int val): mu__byte(19, 29, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1__type_0::values[] = {"H_Invalid","H_Modified","H_Shared","H_Exclusive","HT_S_D","HT_M_D","HT_M_P","HT_M_A","HT_S_P","HT_I_P","HT_E_P",NULL };
...
class mu_1__type_2: public mu__byte
{
 public:
  ...
  mu_1__type_2 (char *name, int os): mu__byte(30, 42, 4, name, os) {};
  mu_1__type_2 (void): mu__byte(30, 42, 4) {};
  mu_1__type_2 (int val): mu__byte(30, 42, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1__type_2::values[] = {"P_Invalid","P_Shared","P_Modified","P_Exclusive","PT_IS_D","PT_IM_AD","PT_IM_A","PT_SM_AD","PT_SM_A","PT_MI_A","PT_SI_A","PT_II_A","PT_EI_A",NULL };
...
const int mu_H_Modified = 20;
const int mu_H_Shared = 21;
const int mu_H_Exclusive = 22;
const int mu_HT_S_D = 23;
const int mu_HT_M_D = 24;
const int mu_HT_M_P = 25;
const int mu_HT_M_A = 26;
const int mu_HT_S_P = 27;
const int mu_HT_I_P = 28;
const int mu_HT_E_P = 29;
const int mu_P_Invalid = 30;
const int mu_P_Shared = 31;
const int mu_P_Modified = 32;
const int mu_P_Exclusive = 33;
const int mu_PT_IS_D = 34;
const int mu_PT_IM_AD = 35;
const int mu_PT_IM_A = 36;
const int mu_PT_SM_AD = 37;
const int mu_PT_SM_A = 38;
const int mu_PT_MI_A = 39;
const int mu_PT_SI_A = 40;
const int mu_PT_II_A = 41;
const int mu_PT_EI_A = 42;
...
const unsigned numrules = 128;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 128
...
/********************
  Invariant records
 ********************/
int mu__invariant_18() // Invariant "values in exlusive state match memory"
{
bool mu__quant19; 
mu__quant19 = TRUE;
{
...
bool mu__boolexpr20;
bool mu__boolexpr21;
  if (!((mu_HomeNode.mu_state) == (mu_H_Exclusive))) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = ((mu_Procs[mu_n].mu_state) == (mu_P_Exclusive)) ; 
}
...
bool mu__condition_22() // Condition for Rule "values in exlusive state match memory"
{
...
int mu__invariant_23() // Invariant "values in shared state match memory"
{
bool mu__quant24; 
mu__quant24 = TRUE;
{
...
bool mu__boolexpr25;
bool mu__boolexpr26;
  if (!((mu_HomeNode.mu_state) == (mu_H_Shared))) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = ((mu_Procs[mu_n].mu_state) == (mu_P_Shared)) ; 
}
...
bool mu__condition_27() // Condition for Rule "values in shared state match memory"
{
...
int mu__invariant_28() // Invariant "Exclusive implies empty sharer list"
{
bool mu__boolexpr29;
  if (!((mu_HomeNode.mu_state) == (mu_H_Exclusive))) mu__boolexpr29 = TRUE ;
  else {
...
/*** end multisetcount 9 declaration ***/
  mu__boolexpr29 = ((mu__intexpr30) == (0)) ; 
}
return mu__boolexpr29;
};

bool mu__condition_31() // Condition for Rule "Exclusive implies empty sharer list"
{
...
int mu__invariant_32() // Invariant "Invalid implies empty sharer list"
{
bool mu__boolexpr33;
  if (!((mu_HomeNode.mu_state) == (mu_H_Invalid))) mu__boolexpr33 = TRUE ;
  else {
...
bool mu__condition_35() // Condition for Rule "Invalid implies empty sharer list"
{
...
int mu__invariant_36() // Invariant "modified implies empty sharers list"
{
bool mu__boolexpr37;
  if (!((mu_HomeNode.mu_state) == (mu_H_Modified))) mu__boolexpr37 = TRUE ;
  else {
...
bool mu__condition_39() // Condition for Rule "modified implies empty sharers list"
{
...
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr42;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_Invalid))) mu__boolexpr42 = TRUE ;
  else {
  mu__boolexpr42 = (mu_Procs[mu_n].mu_val.isundefined()) ; 
}
if ( !(mu__boolexpr42) )
...
int mu__invariant_44() // Invariant "values in exclusive state match last write"
{
bool mu__quant45; 
mu__quant45 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr46;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_Exclusive))) mu__boolexpr46 = TRUE ;
  else {
...
bool mu__condition_47() // Condition for Rule "values in exclusive state match last write"
{
...
int mu__invariant_48() // Invariant "values in modified state match last write"
{
bool mu__quant49; 
mu__quant49 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr50;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_Modified))) mu__boolexpr50 = TRUE ;
  else {
...
bool mu__condition_51() // Condition for Rule "values in modified state match last write"
{
...
{
bool mu__boolexpr53;
  if (!((mu_HomeNode.mu_state) == (mu_H_Invalid))) mu__boolexpr53 = TRUE ;
  else {
...
int mu__invariant_55() // Invariant "value in memory matches value of last write, when shared "
{
bool mu__boolexpr56;
  if (!((mu_HomeNode.mu_state) == (mu_H_Shared))) mu__boolexpr56 = TRUE ;
  else {
...
bool mu__condition_57() // Condition for Rule "value in memory matches value of last write, when shared "
{
...
int mu__invariant_58() // Invariant "Shared implies empty owner"
{
bool mu__boolexpr59;
  if (!((mu_HomeNode.mu_state) == (mu_H_Shared))) mu__boolexpr59 = TRUE ;
  else {
  mu__boolexpr59 = (mu_HomeNode.mu_owner.isundefined()) ; 
}
return mu__boolexpr59;
};

bool mu__condition_60() // Condition for Rule "Shared implies empty owner"
{
...
{
bool mu__boolexpr62;
  if (!((mu_HomeNode.mu_state) == (mu_H_Invalid))) mu__boolexpr62 = TRUE ;
  else {
  mu__boolexpr62 = (mu_HomeNode.mu_owner.isundefined()) ; 
}
...
{"Invalid implies empty owner", &mu__condition_63, NULL, FALSE},
{"Shared implies empty owner", &mu__condition_60, NULL, FALSE},
{"value in memory matches value of last write, when shared ", &mu__condition_57, NULL, FALSE},
{"value in memory matches value of last write, when invalid", &mu__condition_54, NULL, FALSE},
{"values in modified state match last write", &mu__condition_51, NULL, FALSE},
{"values in exclusive state match last write", &mu__condition_47, NULL, FALSE},
{"value is undefined while invalid", &mu__condition_43, NULL, FALSE},
{"modified implies empty sharers list", &mu__condition_39, NULL, FALSE},
{"Invalid implies empty sharer list", &mu__condition_35, NULL, FALSE},
{"Exclusive implies empty sharer list", &mu__condition_31, NULL, FALSE},
{"values in shared state match memory", &mu__condition_27, NULL, FALSE},
{"values in exlusive state match memory", &mu__condition_22, NULL, FALSE},
};
