/******************************
  Program "chengfu.m" compiled by "Murphi Release 3.1"
...
#define PROTOCOL_NAME "chengfu"
#define BITS_IN_WORLD 1408
#define ALIGN
...
class mu_1_Acknowledge: public mu__byte
{
 public:
  inline int operator=(int val) { return mu__byte::operator=(val); };
  inline int operator=(const mu_1_Acknowledge& val) { return mu__byte::operator=((int) val); };
  mu_1_Acknowledge (char *name, int os): mu__byte(0, 3, 3, name, os) {};
  mu_1_Acknowledge (void): mu__byte(0, 3, 3) {};
  mu_1_Acknowledge (int val): mu__byte(0, 3, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
mu_1_Acknowledge mu_1_Acknowledge_undefined_var;
...
char *mu_1_MessageType::values[] = {"GetS","GetM","PutS","PutM","InvAck","Data","FwdAck","TranAck","FwdGetS","FwdGetM","PutAck","Inv",NULL };
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (char *name, int os): mu__byte(18, 24, 3, name, os) {};
  mu_1__type_0 (void): mu__byte(18, 24, 3) {};
  mu_1__type_0 (int val): mu__byte(18, 24, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1__type_0::values[] = {"H_I","H_S","H_M","H_MM_Wait","H_MS_Wait","H_SM_Wait","H_IM_Wait",NULL };
...
char *mu_1__type_2::values[] = {"P_I","P_S","P_M","P_IS_D","P_IM_AD","P_IM_A","P_SM_AD","P_SM_A","P_SI_A","P_MI_A","P_II_A",NULL };
...
void mu_1__type_4::set_self( char *n, int os)
{
  ...
  name = n;
  for(i = 0; i < 4; i++)
    array[i].set_self(tsprintf("%s{%d}", n,i), i * 40 + os);
  k = os + i * 40;
  for(i = 0; i < 4; i++)
    valid[i].set_self("", i * 8 + k);
};
...
void mu_1__type_7::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"HomeType", i * 120 + os);i++;
...
const int mu_PutS = 8;
const int mu_PutM = 9;
const int mu_InvAck = 10;
const int mu_Data = 11;
const int mu_FwdAck = 12;
const int mu_TranAck = 13;
const int mu_FwdGetS = 14;
const int mu_FwdGetM = 15;
const int mu_PutAck = 16;
const int mu_Inv = 17;
const int mu_H_I = 18;
const int mu_H_S = 19;
const int mu_H_M = 20;
const int mu_H_MM_Wait = 21;
const int mu_H_MS_Wait = 22;
const int mu_H_SM_Wait = 23;
const int mu_H_IM_Wait = 24;
const int mu_P_I = 25;
const int mu_P_S = 26;
const int mu_P_M = 27;
const int mu_P_IS_D = 28;
const int mu_P_IM_AD = 29;
const int mu_P_IM_A = 30;
const int mu_P_SM_AD = 31;
const int mu_P_SM_A = 32;
const int mu_P_SI_A = 33;
const int mu_P_MI_A = 34;
const int mu_P_II_A = 35;
...
/*** Variable declaration ***/
mu_1__type_5 mu_Net("Net",144);

/*** Variable declaration ***/
mu_1__type_7 mu_InBox("InBox",912);
...
void mu_Send(const mu_1_MessageType& mu_mtype, const mu_1_Node& mu_dst, const mu_1_Node& mu_src, const mu_1_VCType& mu_vc, const mu_1_Value& mu_val, const mu_1_Acknowledge& mu_ack)
{
/*** Variable declaration ***/
...
{
Error.Error("Error: Unhandled message");
};
/*** end procedure declaration ***/
...
void mu_AddToSharerList(const mu_1_Node& mu_n)
{
...
if ( (mu_n) != (mu_rqst) )
{
mu_Send ( mu_Inv, mu_n, mu_rqst, mu_VC1, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
}
}
};
};
...
mu_AddToSharerList ( mu_msg.mu_src );
...
switch ((int) mu_msg.mu_mtype) {
case mu_GetS:
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_HomeNode.mu_val, mu_1_Acknowledge_undefined_var );
mu_AddToSharerList ( mu_msg.mu_src );
break;
case mu_GetM:
if ( mu_IsSharer( mu_msg.mu_src ) )
{
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_HomeNode.mu_val, (mu_cnt) - (1) );
}
else
{
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_HomeNode.mu_val, (int)mu_cnt );
...
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC1, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
break;
case mu_PutM:
mu_RemoveFromSharersList ( mu_msg.mu_src );
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC1, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
...
switch ((int) mu_msg.mu_mtype) {
case mu_GetS:
mu_Send ( mu_FwdGetS, mu_HomeNode.mu_owner, mu_msg.mu_src, mu_VC1, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
mu_AddToSharerList ( mu_msg.mu_src );
mu_AddToSharerList ( mu_HomeNode.mu_owner );
mu_HomeNode.mu_state = mu_H_MS_Wait;
break;
case mu_GetM:
mu_Send ( mu_FwdGetM, mu_HomeNode.mu_owner, mu_msg.mu_src, mu_VC1, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
mu_HomeNode.mu_state = mu_H_MM_Wait;
break;
case mu_PutS:
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC1, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
break;
...
case mu_PutM:
bool mu__boolexpr18;
  if (mu_IsSharer( mu_msg.mu_src )) mu__boolexpr18 = TRUE ;
  else {
  mu__boolexpr18 = ((mu_HomeNode.mu_owner) == (mu_msg.mu_src)) ; 
}
if ( mu__boolexpr18 )
{
mu_msg_processed = mu_false;
...
{
  mu_1_Acknowledge& mu_pa = mu_Procs[mu_p].mu_ack;
switch ((int) mu_ps) {
case mu_P_I:
switch ((int) mu_msg.mu_mtype) {
case mu_FwdGetS:
mu_Send ( mu_FwdAck, (int)mu_HomeType, (int)mu_p, mu_VC2, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
break;
case mu_FwdGetM:
mu_Send ( mu_FwdAck, (int)mu_HomeType, (int)mu_p, mu_VC2, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
break;
...
break;
case mu_P_M:
if ( !((mu_pa) == (0)) ) Error.Error("Assertion failed: ack is not 0 in modified state");
switch ((int) mu_msg.mu_mtype) {
case mu_FwdGetS:
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_p, mu_VC2, mu_pv, mu_1_Acknowledge_undefined_var );
mu_Send ( mu_Data, (int)mu_HomeType, (int)mu_p, mu_VC2, mu_pv, mu_1_Acknowledge_undefined_var );
mu_pa = 0;
mu_ps = mu_P_S;
break;
case mu_FwdGetM:
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_p, mu_VC2, mu_pv, mu_1_Acknowledge_undefined_var );
mu_Send ( mu_FwdAck, (int)mu_HomeType, mu_msg.mu_src, mu_VC2, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
mu_pv.undefine();
mu_ps = mu_P_I;
break;
default:
...
switch ((int) mu_msg.mu_mtype) {
case mu_Inv:
mu_Send ( mu_InvAck, mu_msg.mu_src, (int)mu_p, mu_VC2, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
mu_pv.undefine();
mu_ps = mu_P_I;
break;
default:
...
if ( (mu_msg.mu_src) == (mu_HomeType) )
{
mu_pa = (mu_msg.mu_ack) - (mu_pa);
bool mu__boolexpr19;
  if ((mu_msg.mu_ack) == (0)) mu__boolexpr19 = TRUE ;
  else {
  mu__boolexpr19 = ((mu_pa) == (0)) ; 
}
if ( mu__boolexpr19 )
{
mu_Send ( mu_TranAck, (int)mu_HomeType, (int)mu_p, mu_VC2, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
mu_pv = mu_msg.mu_val;
mu_ps = mu_P_M;
}
else
...
public:
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_PutM, (int)mu_HomeType, (int)mu_n, mu_VC0, mu_p.mu_val, mu_1_Acknowledge_undefined_var );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("evict shared block, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_PutS, (int)mu_HomeType, (int)mu_n, mu_VC0, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
...
public:
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_GetS, (int)mu_HomeType, (int)mu_n, mu_VC0, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store request on I, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_GetM, (int)mu_HomeType, (int)mu_n, mu_VC0, mu_1_Value_undefined_var, mu_1_Acknowledge_undefined_var );
mu_p.mu_ack = 0;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store request on S, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store new value on M, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
const unsigned numrules = 46;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 46
...
int mu__invariant_25() // Invariant "values in memory matches value of last write, when shared or invalid"
{
bool mu__quant26; 
mu__quant26 = TRUE;
{
...
bool mu__boolexpr27;
bool mu__boolexpr28;
  if ((mu_HomeNode.mu_state) == (mu_H_S)) mu__boolexpr28 = TRUE ;
  else {
  mu__boolexpr28 = ((mu_HomeNode.mu_state) == (mu_H_I)) ; 
}
  if (!(mu__boolexpr28)) mu__boolexpr27 = TRUE ;
  else {
  mu__boolexpr27 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr27) )
...
bool mu__condition_29() // Condition for Rule "values in memory matches value of last write, when shared or invalid"
{
...
int mu__invariant_30() // Invariant "Invalid implies empty sharer list"
{
bool mu__boolexpr31;
...
bool mu__condition_33() // Condition for Rule "Invalid implies empty sharer list"
{
...
int mu__invariant_34() // Invariant "modified implies empty sharers list"
{
bool mu__boolexpr35;
  if (!((mu_HomeNode.mu_state) == (mu_H_M))) mu__boolexpr35 = TRUE ;
  else {
...
bool mu__condition_37() // Condition for Rule "modified implies empty sharers list"
{
...
int mu__invariant_38() // Invariant "value is undefined while invalid"
{
bool mu__quant39; 
mu__quant39 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr40;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_I))) mu__boolexpr40 = TRUE ;
  else {
  mu__boolexpr40 = (mu_Procs[mu_n].mu_val.isundefined()) ; 
}
if ( !(mu__boolexpr40) )
...
bool mu__condition_41() // Condition for Rule "value is undefined while invalid"
{
...
bool mu__boolexpr44;
bool mu__boolexpr45;
  if ((mu_Procs[mu_n].mu_state) == (mu_P_S)) mu__boolexpr45 = TRUE ;
  else {
  mu__boolexpr45 = ((mu_Procs[mu_n].mu_state) == (mu_P_M)) ; 
}
...
bool mu__boolexpr48;
  ...
  mu__boolexpr48 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
...
bool mu__boolexpr51;
  ...
  mu__boolexpr51 = (mu_HomeNode.mu_owner.isundefined()) ; 
}
...
{"Invalid implies empty owner", &mu__condition_52, NULL, FALSE},
{"value in memory matches value of last write, when invalid", &mu__condition_49, NULL, FALSE},
{"values in valid state match last write", &mu__condition_46, NULL, FALSE},
{"value is undefined while invalid", &mu__condition_41, NULL, FALSE},
{"modified implies empty sharers list", &mu__condition_37, NULL, FALSE},
{"Invalid implies empty sharer list", &mu__condition_33, NULL, FALSE},
{"values in memory matches value of last write, when shared or invalid", &mu__condition_29, NULL, FALSE},
...
void mu_1_Acknowledge::Permute(PermSet& Perm, int i) {};
void mu_1_Acknowledge::SimpleCanonicalize(PermSet& Perm) {};
void mu_1_Acknowledge::Canonicalize(PermSet& Perm) {};
void mu_1_Acknowledge::SimpleLimit(PermSet& Perm) {};
void mu_1_Acknowledge::ArrayLimit(PermSet& Perm) {};
void mu_1_Acknowledge::Limit(PermSet& Perm) {};
void mu_1_Acknowledge::MultisetLimit(PermSet& Perm)
