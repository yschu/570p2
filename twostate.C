...
class mu_1_MessageType: public mu__byte
{
 public:
  ...
  mu_1_MessageType (char *name, int os): mu__byte(6, 10, 3, name, os) {};
  mu_1_MessageType (void): mu__byte(6, 10, 3) {};
  mu_1_MessageType (int val): mu__byte(6, 10, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_0::values[ int(val) - 11] );
    else return ( s << "Undefined" );
  };

  mu_1__type_0 (char *name, int os): mu__byte(11, 13, 2, name, os) {};
  mu_1__type_0 (void): mu__byte(11, 13, 2) {};
  mu_1__type_0 (int val): mu__byte(11, 13, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  mu_1__type_1 (char *name, int os): mu__byte(14, 17, 3, name, os) {};
  mu_1__type_1 (void): mu__byte(14, 17, 3) {};
  mu_1__type_1 (int val): mu__byte(14, 17, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const int mu_ReadReq = 6;
const int mu_ReadAck = 7;
const int mu_WBReq = 8;
const int mu_WBAck = 9;
const int mu_RecallReq = 10;
const int mu_H_Valid = 11;
const int mu_H_Invalid = 12;
const int mu_HT_Pending = 13;
const int mu_P_Valid = 14;
const int mu_P_Invalid = 15;
const int mu_PT_Pending = 16;
const int mu_PT_WritebackPending = 17;
...
bool Condition(unsigned r)
{
  ...
  if (r>=30 && r<=32) return R4.Condition(r-30);
...
void Code(unsigned r)
{
  ...
  if (r>=30 && r<=32) { R4.Code(r-30); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=30 && r<=32) { return R4.Priority(); } 
}
char * Name(unsigned r)
{
  ...
  if (r>=30 && r<=32) return R4.Name(r-30);
  return NULL;
}
};
